package skim.springframework.msscbrewery.web.controller.v2;
...
public class BeerControllerV2 {
    ...
    @PutMapping({"/{beerId}"})
    public ResponseEntity<HttpHeaders> handleUpdate(@PathVariable("beerId") UUID beerId, @Valid @RequestBody BeerDtoV2 beerDto) {
